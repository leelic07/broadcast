<template>
  <el-row class="broadcast-edit-container">
      ...
      <el-card>
        ...
        <el-form label-position="top" :model="broadForEdit">
          ...
          <el-form-item>
            ...
            <el-col v-else v-for="(file,index) in broadForEdit.refs" :key="index">
              <el-col :span="22">
                <audio :src="file.filename" controls></audio>
              </el-col>
              <el-col :span="2">
                <el-button type="text" @click="showDetail(file.id)">详情</el-button>
              </el-col>
            </el-col>
          </el-form-item>
          <el-form-item>
    ...
    <el-dialog title="记录详情" :visible.sync="dialogFormVisible">
